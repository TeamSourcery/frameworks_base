/*
 * Copyright 2011  by Mike Wilson - Zaphod-Beeblebrox
 *
...
public class SourceryTarget {
    ...
    final String TAG = "SOURCERYTarget";
    ...
    public final static String ACTION_RECENT_APPS = "**recentapps**";
   ...
   public Drawable getIconImage(String uri) {
        ...
        if (uri.equals(ACTION_RECENT_APPS))
            return mContext.getResources().getDrawable(R.drawable.ic_sysbar_recent_apps);
