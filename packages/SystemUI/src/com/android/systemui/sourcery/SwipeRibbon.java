...
public class SwipeRibbon extends LinearLayout {
    ...
    public SwipeRibbon(Context context, AttributeSet attrs, String location) {
        super(context, attrs);
        mContext = context;
        mLocation = location;
    ...
    private void setupRibbon() {
        ...
        if (mLocation.equals("bottom")) {
            ...
            sv = RibbonHelper.getVerticalRibbon(mContext,
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_TARGETS_SHORT[RibbonHelper.SWIPE_RIBBON]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_TARGETS_LONG[RibbonHelper.SWIPE_RIBBON]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_TARGETS_ICONS[RibbonHelper.SWIPE_RIBBON]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.ENABLE_RIBBON_TEXT[RibbonHelper.SWIPE_RIBBON]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_ICON_SIZE[RibbonHelper.SWIPE_RIBBON]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_TEXT_COLOR[RibbonHelper.SWIPE_RIBBON]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_ICON_LOCATION), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_ICON_SPACE[RibbonHelper.SWIPE_RIBBON]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_ICON_SPACE_VERTICAL), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_ICON_VIBRATE[RibbonHelper.SWIPE_RIBBON]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_ICON_COLORIZE[RibbonHelper.SWIPE_RIBBON]), false, this);
            for (int i = 0; i < 3; i++) {
   ...
   protected void updateSettings() {
        ...
        shortTargets = Settings.System.getArrayList(cr,
                 Settings.System.RIBBON_TARGETS_SHORT[RibbonHelper.SWIPE_RIBBON]);
        longTargets = Settings.System.getArrayList(cr,
                 Settings.System.RIBBON_TARGETS_LONG[RibbonHelper.SWIPE_RIBBON]);
        customIcons = Settings.System.getArrayList(cr,
                 Settings.System.RIBBON_TARGETS_ICONS[RibbonHelper.SWIPE_RIBBON]);
        mText = Settings.System.getBoolean(cr,
                 Settings.System.ENABLE_RIBBON_TEXT[RibbonHelper.SWIPE_RIBBON], true);
        mTextColor = Settings.System.getInt(cr,
                 Settings.System.RIBBON_TEXT_COLOR[RibbonHelper.SWIPE_RIBBON], -1);
        mSize = Settings.System.getInt(cr,
                 Settings.System.RIBBON_ICON_SIZE[RibbonHelper.SWIPE_RIBBON], 0);
        ...
        mHorizontalPad = Settings.System.getInt(cr,
                 Settings.System.RIBBON_ICON_SPACE[RibbonHelper.SWIPE_RIBBON], 5);
        mVerticalPad = Settings.System.getInt(cr,
                 Settings.System.RIBBON_ICON_SPACE_VERTICAL, 1);
        mVib = Settings.System.getBoolean(cr,
                 Settings.System.RIBBON_ICON_VIBRATE[RibbonHelper.SWIPE_RIBBON], true);
        mColorize = Settings.System.getBoolean(cr,
                 Settings.System.RIBBON_ICON_COLORIZE[RibbonHelper.SWIPE_RIBBON], false);
