...
import static com.android.internal.util.sourcery.AwesomeConstants.*;
import com.android.internal.util.sourcery.RibbonHelper;
import com.android.internal.util.sourcery.LockScreenHelpers;
...
public class KeyguardSelectorView extends LinearLayout implements KeyguardSecurityView {
    ...
    private final long KEEP_AWAKE = 60000;
    ...
    private void launchAction(String action) {
        ...
        case ACTION_APP:
            ...
            mCallback.dismiss(false);
            Intent i = new Intent();
            i.setAction("com.android.systemui.sourcery.LAUNCH_ACTION");
    ...
    protected void onFinishInflate() {
        ...
        mRibbon.addView(RibbonHelper.getRibbon(mContext,
            Settings.System.getArrayList(cr,
                Settings.System.RIBBON_TARGETS_SHORT[RibbonHelper.LOCKSCREEN]),
            Settings.System.getArrayList(cr,
                Settings.System.RIBBON_TARGETS_LONG[RibbonHelper.LOCKSCREEN]),
            Settings.System.getArrayList(cr,
                Settings.System.RIBBON_TARGETS_ICONS[RibbonHelper.LOCKSCREEN]),
            Settings.System.getBoolean(cr,
                Settings.System.ENABLE_RIBBON_TEXT[RibbonHelper.LOCKSCREEN], true),
            Settings.System.getInt(cr,
                Settings.System.RIBBON_TEXT_COLOR[RibbonHelper.LOCKSCREEN], -1),
            Settings.System.getInt(cr,
                Settings.System.RIBBON_ICON_SIZE[RibbonHelper.LOCKSCREEN], 0),
            Settings.System.getInt(cr,
                Settings.System.RIBBON_ICON_SPACE[RibbonHelper.LOCKSCREEN], 5),
            Settings.System.getBoolean(cr,
                Settings.System.RIBBON_ICON_VIBRATE[RibbonHelper.LOCKSCREEN], true),
            Settings.System.getBoolean(cr,
                Settings.System.RIBBON_ICON_COLORIZE[RibbonHelper.LOCKSCREEN], true), 0));
        updateTargets();
    ...
    private void torchOff() {
        Intent intent = new Intent("com.sourcery.torch.INTENT_TORCH_OFF");
        intent.setComponent(ComponentName.unflattenFromString
                ("com.sourcery.Torch/.TorchReceiver"));
        intent.setAction("com.sourcery.torch.INTENT_TORCH_OFF");
    ...
    final Runnable startTorch = new Runnable () {
        public void run() {
            ...
            if (!torchActive && !mGlowTorchOn) {
                ...
                mGlowTorchOn = true;
                vibrate();
                Intent intent = new Intent("com.sourcery.torch.INTENT_TORCH_ON");
                intent.setComponent(ComponentName.unflattenFromString
                        ("com.sourcery.Torch/.TorchReceiver"));
                intent.setAction("com.sourcery.torch.INTENT_TORCH_ON");
                mContext.sendBroadcast(intent);
            }
        }
    };
